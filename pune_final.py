...
index=1
fh=open('ahmedabad_Agents_link.txt','r')
...
for url in a:
	...
	try:
		address=tree.xpath('/html/body/div[2]/div[1]/div/div[4]/div[1]/div[1]/ul/li/span/span[@id=\'fulladdress\']')[0]
		address=address.xpath('//span[@id=\'fulladdress\']/span/span[@class=\'lng_add\']')[0].text
	except:
		print('Address Not Found')
		address=''
	website=""
	try:
		info_elements=tree.xpath('/html/body/div[2]/div[1]/div/div[4]/div[1]/div[1]/ul/li/i[@class=\'web_ic sprite_wb comp-icon\']')
		span=info_elements[0].getnext()
		website=span.getchildren()[0].attrib['href']
	except:
		website="None"
	...
	if (index)%100==0:
		output_file = 'TravelAgentPuneScrappedAt '+str(time.time())+'.xls'
